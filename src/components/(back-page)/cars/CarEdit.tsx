...
import { Edit, SimpleForm, TextInput, NumberInput, SelectInput, required, ImageInput, ImageField, EditProps } from 'react-admin';

const CarEdit: React.FC<EditProps> = (props) => {
    return (
        <div className="flex justify-center items-center bg-gray-100">
            <Edit {...props} className="w-full max-w-3xl bg-white shadow-lg rounded-lg px-8">
                <SimpleForm>
